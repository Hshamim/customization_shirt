...
var app = new Vue({
  ...
  data: {
    ...
    updatecuffButton(variantImageCUFFB) {
      this.cuffBbutton = 'imge/Shirt_Back/' + variantImageCUFFB
    },
    updatecuffButtonThread(variantImageCUFFT) {
      var selected = document.querySelector(
        'input[type=radio][name=checkColor]:checked'
      )
      this.cuffBbuttonthread = 'imge/Shirt_Back/' + variantImageCUFFT + selected.value;
    },
  ...
  methods: {
    ...
    updateProductCustomCuff(variantImage) {
      ...
      this.collar_custom_cuff = "imge/Shirt_Front/9.shirt-customize-collar/shirt-customize-collar_all fabrics/shirt-customize-collar_all fabrics-102.png";
      this.collars_custom_cuff = "imge/Shirt_Side/9.shirt-customize-collar/shirt-customize-collar_all fabrics/shirt-customize-collar_all fabrics-102.png";
      this.collarb_custom_cuff = 'imge/Shirt_Back/9.shirt-customize-collar/shirt-customize-collar_all fabrics/shirt-customize-collar_all fabrics-101.png';
